...
import (
	...
	"github.com/sniperkit/snk.fork.palantir-godel-okgo-asset-importalias/importalias/config/internal/legacy"
	"github.com/sniperkit/snk.fork.palantir-godel-okgo-asset-importalias/importalias/config/internal/v0"
)
